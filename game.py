# Learn Tutorial by kidscancode.org
import pygame
import random
from os import path
...
pygame.display.set_caption("Wing of Zero: Basic vs. Elite")
...
def show_go_screen():
    ...
    draw_text(screen, "Wing of Zero:", 44, WIDTH / 2, HEIGHT / 4)
    draw_text(screen, "Basic vs. Elite", 34, WIDTH / 2, HEIGHT / 2.9)
